...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {// console.log(this.card.title);
...
Nova.booting(function (Vue, router, store) {
  Vue.component("marshmallow-help", __webpack_require__(/*! ./components/Card */ "./resources/js/components/Card.vue").default);
});
                    ...
                    [
                      _c(
                        "a",
                        {
                          ...
                          attrs: { href: item.link, target: item.link_target }
                        },
                        [
                          _c("div", {
                            staticClass:
