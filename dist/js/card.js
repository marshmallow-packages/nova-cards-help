...
Nova.booting(function (Vue, router, store) {
  Vue.component('marshmallow-help', __webpack_require__(2));
});
    ...
    _c(
      ...
      [
        _c("heading", { staticClass: "flex mb-3" }, [
          _vm._v("\n      " + _vm._s(_vm.__(_vm.card.title)) + "\n    ")
        ]),
        _vm._v(" "),
        _c("p", { staticClass: "text-90 leading-tight mb-8" }, [
          _vm._v("\n      " + _vm._s(_vm.__(_vm.card.description)) + "\n    ")
        ]),
        _vm._v(" "),
        _c("card", [
          _c(
            ...
            _vm._l(_vm.card.items, function(item_row) {
              return _c(
                "tr",
                _vm._l(item_row, function(item) {
                  return _c(
                    "td",
                    {
                        ...
                        [
                          ...
                          _c(
                            ...
                            [
                              ...
                              _vm._v(" "),
                              _c("p", {
                                staticClass: "text-90 leading-normal",
                                domProps: {
